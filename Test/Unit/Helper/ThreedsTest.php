 ...
 */
class ThreedsTest extends \Ecomprocessing\Genesis\Test\Unit\AbstractTestCase
{
    /**
     * @var Threeds
     */
    ...
    /**
     * @var \Ecomprocessing\Genesis\Helper\Data|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    {
        $this->assertEquals('Ecomprocessing\Genesis\Helper\Threeds', get_class($this->threedsHelper));
    }
    ...
    {
        $this->moduleHelper = $this->getMockBuilder(\Ecomprocessing\Genesis\Helper\Data::class)
            ->disableOriginalConstructor()
            ->setMethods(
                [
                    'getMethodConfig',
